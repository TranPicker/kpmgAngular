    ...
    $('#calendar').fullCalendar({
      ...
      events    : [
        ...
        },
        {
          ...
          end            : moment('2018-08-08').format('YYYY-MM-DD') + ' 22:00',
          imageurl: 'assets/images/beer.jpeg',
      ...
      eventRender: function(event, eventElement) {
        ...
        // }
        eventElement.append('<div class="content_event"><img style="float: right;height: 16px" src="assets/images/icon/close.png" class="remove_event"><span class="time">'+event.start.format('hh:mma')+'-'+event.end.format('hh:mma')+'</span>' +
          '<div class="img_event"><img src="'+ event.imageurl +'" width='+50+' height='+40+'></div>' +
          '<div class="content"><div style="font-weight: bold"><span>'+event.title+'</span></div><div><span>'+event.description+'</span></div></div>' +
          '</div>');
